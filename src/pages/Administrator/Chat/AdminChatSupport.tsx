...
import ChatListPanel from "../../../components/Chat Support/Administrator/ChatListPanel";
import ChatWindow from "../../../components/Chat Support/Administrator/ChatWindow";
...
const AdminChatSupport = ({ alertsRef }: Props) => {
  ...
  const fetchChatList = async () => {
    try {
      const res = await fetch(`${API_BASE_URL}/admin/chats/barangays`, {
        headers: {
