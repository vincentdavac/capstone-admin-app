...
const staticChartDataWater = [
    ...
    { name: 'Jul', value: 28.0 },
    { name: 'Aug', value: 28.5 },
    { name: 'Sept', value: 27.8 },
];
const CHART_MAX_VALUE = 30;

const PlaceholderChart: React.FC<{ title: string, data: typeof staticChartDataWater, unit: string, maxValue: number }> = ({ title, data, unit, maxValue }) => {
    ...
    const yAxisLabels = [0, maxValue * 0.2, maxValue * 0.4, maxValue * 0.6, maxValue * 0.8, maxValue].map(v => v.toFixed(1));
...
// --- END: ADAPTED CHART COMPONENT ---


// --- START: MONITORING TABLE COMPONENT (Water Temperature) ---
        ...
        <div className="w-full bg-white dark:bg-gray-800 shadow-md rounded-lg p-4 mt-4 border border-gray-200 dark:border-gray-700">
            ...
            <div className="w-full px-4 pt-2 pb-4 sm:px-6">
                <h1 className="text-xl font-normal text-gray-700 dark:text-gray-100">
                    Water Temperature Monitoring Table
                </h1>
            </div>

            {/* Table Container: Responsive with overflow-x-auto */}
            <div className="overflow-x-auto mx-2 sm:mx-4 mb-4 border border-gray-300 dark:border-gray-600 rounded-xl shadow-sm">
                <table className="min-w-full text-sm text-center border-collapse text-gray-800 dark:text-gray-200">
                    <thead className="text-sm font-normal bg-gray-50 dark:bg-gray-700 text-gray-500 dark:text-gray-300 border-b border-gray-200 dark:border-gray-600">
                        <tr>
                            <th className="px-4 py-4 font-normal whitespace-nowrap">Temperature (°C)</th>
                            <th className="px-4 py-4 font-normal whitespace-nowrap">Temperature (°F)</th>
...
// --- END: MONITORING TABLE COMPONENT ---
...
const WaterMonitoring: React.FC = () => {
    ...
    return (
        ...
        <div className="p-4 lg:p-6">
            ...
            {/* ⬅️ APPLIED PAGE BREADCRUMB HERE */}
            <PageBreadcrumb pageTitle="Water Temperature" />

            <div className="lg:col-span-2 flex flex-col">
                {/* Main section card (container for chart and table) */}
                <div className="border border-gray-300 dark:border-gray-700 w-full rounded-xl p-4 mt-4 bg-white dark:bg-gray-900">
                    
                    {/* Header with Export Button (Matching HISTORICAL TABLE design) */}
