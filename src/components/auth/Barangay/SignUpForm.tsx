...
export default function SignUpForm({ alertsRef }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(`${API_BASE_URL}/barangay/register`, {
        method: "POST",
        headers: { Accept: "application/json" },
        body: formData,
      });
            ...
            <div className="relative rounded-xl border border-white/20 bg-white/10 backdrop-blur-sm shadow-lg p-6 max-h-[80vh] flex flex-col">
              ...
              <div className="mb-6 space-y-4 text-sm text-white/90 overflow-y-auto pr-2 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                <div>
                  ...
                  <p>
                    By accessing, browsing, or using the X-STREAM website or
                    application, you agree to these Terms and Conditions and all
                    applicable laws and regulations. If you do not agree with
                    any part of these terms, you are not permitted to use the
                    platform.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    X-STREAM is a research-based river monitoring and alert
                    system designed to provide real-time data and support
                    disaster preparedness. The website serves as an information
                    and monitoring platform where authorized users can:
                  </p>
                  <ul className="ml-4 list-disc">
                    <li>
                      View live river condition data collected by X-STREAM
                      sensors and buoys.
                    </li>
                    <li>
                      Access alerts and updates provided by disaster responders
                      or administrators.
                    </li>
                    <li>
                      Communicate and manage data related to river monitoring
                      activities.
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="ml-4 list-disc">
                    ...
                    <li>
                      Respect all applicable data privacy and security
                      regulations.
                    </li>
                    <li>
                      Avoid actions that could disrupt the operation of the
                      system, such as unauthorized access, tampering, or misuse
                      of data.
                    </li>
                  </ul>
                  <p>
                    Unauthorized attempts to modify, damage, or interfere with
                    the system's operations may result in restricted access and
                ...
                <div>
                  ...
                  <p>
                    While X-STREAM strives to provide accurate and real-time
                    data, it does not guarantee that all sensor readings or
                    transmitted information are free from error. Environmental
                    conditions, connectivity issues, or hardware limitations may
                    affect data accuracy and availability. X-STREAM is a
                    Capstone Project and should not be used as the sole basis
                    for critical emergency decisions.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    Authorized users (such as administrators and responders) may
                    be provided with login credentials. You are responsible for
                    maintaining the confidentiality of your account information
                    and for all actions performed under your account. You agree
                    to immediately notify the X-STREAM team of any unauthorized
                ...
                <div>
                  ...
                  <p>
                    All content on the X-STREAM website, including the system
                    design, layout, text, images, logos, and software, is the
                    intellectual property of the X-STREAM project team. No part
                    of the platform may be reproduced, distributed, or used for
                ...
                <div>
                  ...
                  <ul className="ml-4 list-disc">
                    <li>
                      Damages or losses arising from system downtime, data
                      inaccuracy, or technical issues.
                    </li>
                    <li>
                      Consequences resulting from delayed alerts or incomplete
                      information.
                    </li>
                  </ul>
                  <p>
                    The system is intended for educational and research purposes
                    and not as a replacement for official government disaster
                    monitoring systems.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    We respect your privacy. Any data collected or stored by the
                    system (such as sensor data, user information, or
                    communication logs) will be handled in accordance with our
                    Privacy Policy, which explains how information is used and
                    protected.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    X-STREAM reserves the right to modify or update these Terms
                    and Conditions at any time. Users will be informed of any
                    significant changes, and continued use of the website after
                    updates means acceptance of the revised terms.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    ...
                    and Conditions, you may contact the X-STREAM Project Team
                    at:
                  </p>
                  <p>
                    Email: xstream.2k25@gmail.com
                    <br />
                    Phone Number: 0995-331-3742
                  </p>
                </div>
                ...
                <div className="p-3 mt-4 bg-white/20 rounded-lg">
                  ...
                  <p>
                    This system is part of an academic project under the
                    University of Caloocan City. It is intended for research,
                    educational, and prototype demonstration purposes only.
                  </p>
                </div>
              </div>
              ...
              <div className="mb-6 space-y-4 text-sm text-white/90 overflow-y-auto pr-2 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                <div>
                  ...
                  <p className="ml-4">
                    ...
                    <br />
                    When authorized users (e.g., administrators, responders, or
                    project members) access the system, we may collect:
                  </p>
                  ...
                  <p className="ml-4 mt-2">
                    <strong>b. Environmental and System Data</strong>
                  </p>
                  <ul className="ml-8 list-disc">
                    <li>
                      Real-time river and environmental readings from sensors
                      and devices
                    </li>
                  ...
                  <p>
                    These are collected to improve platform performance and
                    security.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <ul className="ml-4 list-disc">
                    ...
                    <li>
                      Conduct research and analysis for environmental studies
                    </li>
                ...
                <div>
                  ...
                  <ul className="ml-4 list-disc">
                    <li>
                      With authorized project members for research and analysis
                    </li>
                    <li>
                      When required by law or official government requests
                    </li>
                    <li>
                      To ensure public safety in case of environmental or
                      emergency alerts
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <p>
                    ...
                    alteration, or disclosure. However, no system is entirely
                    secure. Users are encouraged to:
                  </p>
                  <ul className="ml-4 list-disc">
                ...
                <div>
                  ...
                  <p>
                    Data collected through the X-STREAM system will be retained
                    only for as long as necessary to fulfill its research and
                    monitoring purposes. After project completion, data may be
                    anonymized or deleted following institutional research
                    guidelines.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    Our website may use cookies or analytics tools to monitor
                    website performance and user engagement. You may disable
                    cookies through your browser settings, but some features of
                    the platform may not function properly as a result.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    The X-STREAM website may contain links to external sites
                    (e.g., partner institutions or government agencies). We are
                ...
                <div>
                  ...
                  <p>
                    Depending on your role and level of access, you have the
                    right to:
                  </p>
                  <ul className="ml-4 list-disc">
                    <li>
                    ...
                    <li>
                      Request deletion of your account or stored data (if
                      applicable)
                    </li>
                ...
                <div>
                  ...
                  <p>
                    ...
                    reflect new features, technologies, or legal requirements.
                    All updates will be posted on this page, and continued use
                    of the platform constitutes acceptance of the revised
                    policy.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    For questions, feedback, or privacy-related concerns, you
                    may contact the X-STREAM Project Team at:
                  </p>
                  <p>
                    Email: xstream.2k25@gmail.com
                    <br />
