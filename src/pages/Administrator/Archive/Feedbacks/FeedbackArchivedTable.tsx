...
import ArchiveSlider from "./FeedbackRestore";
...
const FeedbackArchivedTable = ({ alertsRef, onRefresh }: Props) => {
  ...
  const fetchFeedbacks = async () => {
    setLoading(true);
    try {
      const res = await fetch(`${API_BASE_URL}/archived-feedbacks`, {
        headers: {
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white min-h-[auto]">
      <PageBreadcrumb pageTitle="Archived Feedbacks" />
...
export default FeedbackArchivedTable;
