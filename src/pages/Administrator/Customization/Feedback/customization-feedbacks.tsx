...
const CustomizationFeedbacks: React.FC = () => {
  const [feedbackDescriptionData, setFeedbackDescriptionData] = useState<
    TableItem[]
  >(mockFeedbackDescriptionData);
  const [homepageFeedbackData, setHomepageFeedbackData] = useState<
    HomepageFeedbackItem[]
  >(mockHomepageFeedbackData);

  const [feedbackDescriptionSearchTerm] = useState("");
  const [homepageFeedbackSearchTerm, setHomepageFeedbackSearchTerm] =
    useState("");
  ...
  const [newFeedbackData, setNewFeedbackData] = useState<HomepageFeedbackItem>({
    id: 0,
    name: "",
    role: "",
    description: "",
  ...
  const [feedbackDescriptionCurrentPage, setFeedbackDescriptionCurrentPage] =
    useState(1);
  const [homepageFeedbackCurrentPage, setHomepageFeedbackCurrentPage] =
    useState(1);
  ...
  const filteredHomepageFeedbackData = homepageFeedbackData.filter(
    (item) =>
      item.name
        .toLowerCase()
        .includes(homepageFeedbackSearchTerm.toLowerCase()) ||
      item.role
        .toLowerCase()
        .includes(homepageFeedbackSearchTerm.toLowerCase()) ||
      item.description
  ...
  const lastFeedbackDescriptionItemIndex =
    feedbackDescriptionCurrentPage * itemsPerPage;
  const firstFeedbackDescriptionItemIndex =
    lastFeedbackDescriptionItemIndex - itemsPerPage;
  const paginatedFeedbackDescriptionData =
    filteredFeedbackDescriptionData.slice(
  ...
  const lastHomepageFeedbackItemIndex =
    homepageFeedbackCurrentPage * itemsPerPage;
  const firstHomepageFeedbackItemIndex =
    lastHomepageFeedbackItemIndex - itemsPerPage;
        ...
        <div className="px-6 py-3 border-t border-gray-200 dark:border-gray-700">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex space-x-2">
              <button
                onClick={() =>
                  setFeedbackDescriptionCurrentPage(
                    feedbackDescriptionCurrentPage - 1
                  )
                }
              ...
              <button
                ...
                disabled={
                  feedbackDescriptionCurrentPage ===
                  totalFeedbackDescriptionPages
                }
                className="px-3 py-1 text-sm rounded-lg text-gray-600 dark:text-gray-400 disabled:opacity-50"
              >
                Next
        ...
        <div className="px-6 py-3 border-t border-gray-200 dark:border-gray-700">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex space-x-2">
              <button
                onClick={() =>
                  setHomepageFeedbackCurrentPage(
                    homepageFeedbackCurrentPage - 1
                  )
                }
              ...
              {Array.from(
                { length: totalHomepageFeedbackPages },
                (_, index) => (
                  <button
                    key={index + 1}
              ...
              <button
                ...
                disabled={
                  homepageFeedbackCurrentPage === totalHomepageFeedbackPages
                }
                className="px-3 py-1 text-sm rounded-lg text-gray-600 dark:text-gray-400 disabled:opacity-50"
              >
                Next
                          ...
                          <div>
                            ...
                            <div className="relative">
                              <select
                                ...
                                name="status"
                                value={
                                  (currentUpdateItem as TableItem)?.status ||
                                  "Active"
                                }
                                onChange={(e) =>
                                  setCurrentUpdateItem((prev) =>
