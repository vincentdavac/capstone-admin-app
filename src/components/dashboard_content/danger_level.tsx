        ...
        <div className="grid grid-cols-1 gap-3">
          <div className="w-[512px] h-[192px] bg-white shadow rounded-2xl border border-[#D9D9D9] flex flex-col">
            ...
            <div className="grid grid-cols-3 gap-4 w-full p-4 self-center mt-3 justify-center">
              ...
              <label className="flex items-center justify-between w-[149px] h-[35px] rounded-full border border-blue-400 px-3 cursor-pointer">
                <input
                  type="radio"
                  name="level"
                  value="Medium"
                  ...
                  readOnly
                />
                <span className="flex-1 text-center font-normal text-blue-600">
                  Blue
                </span>
              </label>

              <label className="flex items-center justify-between w-[149px] h-[35px] rounded-full border border-red-500 px-3 cursor-pointer">
                <input
                  type="radio"
                  name="level"
                  value="High"
                  ...
                  readOnly
                />
                <span className="flex-1 text-center font-normal text-red-600">
                  Red
                </span>
              </label>
            </div>
